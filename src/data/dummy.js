...
import avatar from "./avatar-g3344b953a_1280.png";
import avatar2 from "./avatar-g3344b953a_1280.png";
import avatar3 from "./avatar-g3344b953a_1280.png";
import avatar4 from "./avatar-g3344b953a_1280.png";
...
export const EditorData = () => (
  <div>
    <h3>
      As the sun began to set on the horizon, the sky turned a deep shade of
      orange and pink, casting a warm glow over the landscape. The trees swayed
      gently in the evening breeze, their leaves rustling softly in the wind. A
      flock of birds flew overhead, their wings beating rhythmically as they
      made their way towards their nests. In the distance, a lone wolf howled,
      its mournful cry echoing across the hills. The sound sent shivers down the
      spines of the nearby wildlife, causing them to scatter and flee. The wolf,
      sensing its power over the land, continued to howl, letting out a long and
      haunting cry that seemed to go on forever. The air was filled with the
      sweet scent of wildflowers and freshly cut grass, creating a serene and
      peaceful atmosphere. The gentle breeze carried the fragrant aroma through
      the trees and across the fields, enveloping everything in its calming
      embrace. As darkness descended upon the land, the stars began to twinkle
      in the sky, illuminating the world with their soft and gentle light. The
      moon rose slowly over the horizon, casting a pale glow over the landscape.
      The world was transformed into a magical realm, where anything was
      possible and dreams came true.
    </h3>
  </div>
);
...
export const scheduleData = [
  {
    ...
    Location: "Space Center Ethiopia",
  ...
  },
  {
    ...
    Location: "Research Center of Ethiopia",
